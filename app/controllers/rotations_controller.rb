class RotationsController < ApplicationController
  ...
  def index
    ...
    @teams = Team.all.sort_by { |team| [-team.rotations.sum(:participation_value), -team.win_percentage(team.rotations.last), -team.repechage_percentage, -team.tie_break_points, team.name] }
  end
